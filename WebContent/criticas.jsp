...
<rich:panel id="listagem" rendered="#{not empty gerenciadorCriticas.criticas}">
	...
	<rich:dataTable id="criticas" border="1" value="#{gerenciadorCriticas.criticas}" var="c" binding="#{gerenciadorCriticas.objDataTable}" rendered="#{not empty gerenciadorCriticas.criticas}" rows="10">
		...
		<rich:column sortBy="#{c.desconto.idBeneficiario}">
			<f:facet name="header"><h:outputText value="ID Benef."/></f:facet>
			<h:outputText value="#{c.desconto.idBeneficiario}" ></h:outputText>
		</rich:column>		
		...
		<rich:column sortBy="#{c.desconto.documento}">
			<f:facet name="header"><h:outputText value="Documento"/></f:facet>
			<h:outputText value="#{c.desconto.documento}" />
		</rich:column>
		...
		<rich:column sortBy="#{c.desconto.serie}">
			<f:facet name="header"><h:outputText value="Série"/></f:facet>
			<h:outputText value="#{c.desconto.serie}" />
		</rich:column>
		...
		<rich:column sortBy="#{c.desconto.idControle}">
			<f:facet name="header"><h:outputText value="ID. Contr."/></f:facet>
			<h:outputText value="#{c.desconto.idControle}" />
		</rich:column>
		...
		<rich:column>
			...
			<!-- 
			<aj4:commandButton id="criticaManualButton" value="Criticar" action="#{gerenciadorCriticas.editar}" reRender="edicaocriticaForm" rendered="#{c.classificacaoCritica.id >= 900 && c.classificacaoCritica.id <= 999}" disabled="false"/>	
            ...
            <aj4:commandButton id="pagarButton" value="Pagar" action="#{gerenciadorCriticas.editar}" reRender="edicaoPagamentoForm" rendered="#{c.classificacaoCritica.id < 900}" disabled="false"/>	
...
<rich:modalPanel id="panelPagamentoIncondicional" width="400" height="240">
  ...
  <aj4:form id="edicaoPagamentoForm" ajaxSubmit="true" >
    <h:panelGrid columns="2" >
		...
		<h:inputText  value="#{gerenciadorCriticas.critica.desconto.vlInformado}" size="10" >
			<f:convertNumber pattern="###,###,##0.00"/>
			<rich:ajaxValidator event="onblur"/>
		</h:inputText>	
	</h:panelGrid>
